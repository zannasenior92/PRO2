...
int main(int argc, char **argv) {
	...
	inst.model_type = 0;
	char* instances[] = {
		"att48.tsp","att532.tsp","berlin52.tsp","bier127.tsp","burma14.tsp","ch130.tsp",
	"ch150.tsp","d198.tsp","d493.tsp","d657.tsp","eil51.tsp","eil76.tsp","eil101.tsp",
	"fl417.tsp","gil262.tsp","gr202.tsp"
	};

	/* "a280.tsp", DA FARE "ali535.tsp",
	...
	*/
	...
	for (int i = 0; i < sizeof(instances) / sizeof(instances[0]); i++) {
		...
		if (TSPopt(&inst, i+2)) print_error(" error within TSPopt()");
		strcpy(name_file, "");
	}
